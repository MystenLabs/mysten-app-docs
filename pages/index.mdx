...
Unlock the full potential of managing your digital assets on the Sui network with Sui Wallet, now available as both [a browser extension](https://chrome.google.com/webstore/detail/sui-wallet/opcgpfmipidbgpenhmajoajpbobppdil) and a Mobile Wallet (iOS and Android). Sui Wallet provides a comprehensive solution for viewing and managing your coins and NFTs, acquiring new digital assets, and transferring those you own with ease.
