...
##### How do I decide how which validator to stake with?

Choosing a validator is a personal decision. From the Sui Wallet, you can click on the validator address to view their page on the Sui Explorer. Sui Explorer shows information and statistics about the validator, including a link to their website where you can learn more. It also shows past performance, expected rewards, and the validators requested gas price for the next epoch.

Do your own research. If a validator no longer meets the standard requirements for the network, they can be removed in a future epoch. Sui Explorer indicates any validator that is at risk of being removed. If a validator has as Tallying Rule score of 0, it means that other validators have requested that the validator be removed from the validator set.
...
##### What is Sui Explorer and why does Sui Wallet link to it?

Sui Explorer is an app from Mysten Labs that allows anyone to view activity on the Sui Network. Sui Explorer shows all on-chain activity for Sui in real time. You can use the link in Sui Wallet to confirm that your transaction completed as expected on the network. [Visit Sui Explorer.](https://suiexplorer.com)
...
The **Activity** tab on Sui Wallet shows a high-level list of all of your transactions. Click on a transaction to view details about it. You can also view the transaction on Sui Explorer by following the link displayed on the details page. You might need to scroll down to see the link on large or complex transactions.
...
- Check Sui Explorer for any unrecognized activity associated with your wallet address
